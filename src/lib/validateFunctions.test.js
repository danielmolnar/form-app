...
describe('Price Decimal Rule Validation', () => {
  it('should return false when there are more than 3 decimal digits', () => {
...
describe('Price Decimal Expression Validation', () => {
  it('should return false when a p.t. is used instead of a comma to indicate a decimal break', () => {
    const result = isValidPrice('59.9999');
    expect(result).toBeFalsy();
  });
});
